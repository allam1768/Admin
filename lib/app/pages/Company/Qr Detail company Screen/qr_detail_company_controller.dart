...
class QrDetailCompanyController extends GetxController {
  ...
  void onInit() {
    super.onInit();
    // Get QR data from arguments, fallback to empty string if not available
    final args = Get.arguments;
    if (args != null && args['qrData'] != null) {
      qrData.value = args['qrData'];
    } else {
      // If no arguments, keep empty (for route compatibility)
      qrData.value = '';
    }
  }

  void goToDashboard() {
    Get.back(); // Go back to previous screen instead of specific route
  }
  ...
  Future<void> saveQrImage() async {
    try {
      ...
      showCustomSnackbar("Gagal menyimpan QR Code", null);
    }
  }
